<template>
  <section class="result">
    <div class="result__wrapper">
      <h3 class="result__title">Ваш результат рассчитан:</h3>
      <p class="result__text">
        <strong>Вы относитесь к 3%</strong> респондентов, чей уровень интеллекта
      ...
      <button @click="makeRequest" class="result__action-btn">
        <svg
          width="29"
          height="29"
          viewBox="0 0 29 29"
...
.result__action-btn {
  ...
  &:before {
    content: url("@/assets/lightning_PNG9.png");
    position: absolute;
    z-index: -1;
    top: -10px;
    right: -45px;
